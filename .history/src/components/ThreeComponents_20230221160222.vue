...
export default {
  ...
  methods: {
    ...
    createSunMesh() {
      const geometry = new THREE.SphereGeometry(130, 20, 20) 
    ...
    createMarsMesh() {
      const geometry = new THREE.SphereGeometry(31, 20, 20) 
      ...
      // 设置位置
      plane.rotation.x = -0.5 * Math.PI
      plane.position.set(520, 0, 0)
      // plane.
      // 平面对象添加到场景中
      this.scene.add(plane)
    },
    createJupiterMesh() {
      const geometry = new THREE.SphereGeometry(70, 20, 20) 
    ...
    createSaturnMesh() {
      const geometry = new THREE.SphereGeometry(60, 200, 200) 
      ...
      // 设置位置
      plane.rotation.x = -0.5 * Math.PI
      plane.position.set(850, 0, 0)
      // plane.
      // 平面对象添加到场景中
      this.scene.add(plane)
    },
    createUranusMesh() {
      const geometry = new THREE.SphereGeometry(22, 20, 20) 
