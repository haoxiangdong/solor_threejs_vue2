...
// import airplane from "../assets/glb/747airplane.glb"
...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      this.render() // 渲染
      this.gltfmodules() // GlTFLoader

    },
    gltfmodules() {
      var loader = new GlTFLoader();
      loader.load("../assets/glb/747airplane.glb", function (gltf) {
        this.scene.add(gltf.scene);
        // var meshs = gltf.scene.getObjectByName("飞机");
      })
    },
    // 创建场景
    createScene() {
