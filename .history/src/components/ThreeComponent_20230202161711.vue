...
export default {
  ...
  methods: {
    ...
    createMesh() {
      ...
      //从外部读取贴图
      // const texture = textureLoader.load("../assets/img/earth.png",function(){
      // 创建材质
      var texture = new THREE.TextureLoader().load("../assets/img/earth.png")
    ...
    updateFun() {
      ...
      // this.meshMaterial.emissive.color(this.properties.color)
