...
export default {
  ...
  methods: {
    ...
    // 创建网格模型
    createMesh() {
      const geometry = new THREE.PlaneGeometry(1500, 200, 10, 10) // 创建一个平面对象PlaneGeometry
      ...
      this.sphere.position.set(100, 0, 0)
    ...
    createLight() {
      ...
      spotLight.position.set(-70, 100, -50)
    ...
    createCamera() {
      ...
      this.camera.position.set(0, 80, 200) // 设置相机位置
