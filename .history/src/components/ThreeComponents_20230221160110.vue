...
export default {
  ...
  methods: {
    ...
    createSunMesh() {
      const geometry = new THREE.SphereGeometry(130, 200, 200) 
    ...
    createEarthMesh() {
      const geometry = new THREE.SphereGeometry(33, 200, 200) 
    ...
    createMarsMesh() {
      const geometry = new THREE.SphereGeometry(31, 200, 200) 
